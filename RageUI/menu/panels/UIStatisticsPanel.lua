local Statistics = {
    ...
    Text = {
        Left = { X = -40, Y = 15, Scale = 0.32 },
    },
    Bar = { Right = 8, Y = 27, Width = 200, Height = 5, OffsetRatio = 0.5 },
    Divider = {
        [1] = { X = 200, Y = 27, Width = 2, Height = 5 },
        [2] = { X = 200, Y = 27, Width = 2, Height = 5 },
        [3] = { X = 200, Y = 27, Width = 2, Height = 5 },
        [4] = { X = 200, Y = 27, Width = 2, Height = 5 },
        [5] = { X = 200, Y = 27, Width = 2, Height = 5 },
    }
}
...
function RageUI.StatisticPanel(Percent, Text, Index)
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() and (Index == nil or (CurrentMenu.Index == Index)) then
            ...
            RenderText(Text or "", CurrentMenu.X + 8.0, (RageUI.StatisticPanelCount * 40) + CurrentMenu.Y + Statistics.Text.Left.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, 6, Statistics.Text.Left.Scale, 245, 245, 245, 255, 0)
